"""
Django settings for testjksdhfgnkjsdh_f_2 project.
...
ROOT_URLCONF = 'testjksdhfgnkjsdh_f_2.urls'
...
WSGI_APPLICATION = 'testjksdhfgnkjsdh_f_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testjksdhfgnkjsdh_f_2 API",
    "DESCRIPTION": "API documentation for testjksdhfgnkjsdh_f_2 App",
    "VERSION": "v1",
}
